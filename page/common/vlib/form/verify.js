 ...
 * m_verify.run({name: "璩", mobile: "1451444aa"}).then(res => {}).catch(res => {});
 */
import {isObject, isUndefined, isBoolean, isFunction, isArray, isString, isNumber} from 'lib/util/dataType'
import regular from './regular'
import filter from 'vlib/json/filterData'
import merge from 'vlib/json/merge'
import byteLength from 'vlib/str/byteLength'
...
const verify = function(name, val){
    ...
    const classUtil = {
        ...
        verify (validate, value, defaults){
            ...
            if (regular.double(min) && regular.double(value)) {
            ...
            if (regular.double(max) && regular.double(value)) {
